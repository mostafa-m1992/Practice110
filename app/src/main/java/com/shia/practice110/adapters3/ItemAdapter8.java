...
public class ItemAdapter8 extends RecyclerView.Adapter<ItemAdapter8.MyViewHolder> {

    List<Item13> item13s;
    Context context;

    public ItemAdapter8(List<Item13> item13s, Context context) {
    ...
    public MyViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ...
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.list_item13, parent, false);
    ...
    public void onBindViewHolder(@NonNull MyViewHolder holder, int position) {
        ...
        Item13 item13 = item13s.get(position);

        holder.holderImage.setImageResource(item13.getProductImage());
        holder.holderName.setText(item13.getProductName());
